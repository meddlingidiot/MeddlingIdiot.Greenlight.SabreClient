...
/// <summary>
/// Whether the sabre comes back when Windows does. One value under the current user's
...
/// <c>sabre.json</c>: the user can turn the same thing off in Task Manager's Startup tab or
...
public static class WindowsStartup
{
    ...
    /// </summary>
    private const string ValueName = "Greenlight Sabre";

    /// <summary>Whether Windows is currently set to start the sabre.</summary>
    ...
    /// <summary>Ask Windows to start the sabre, or stop asking. Returns what it actually is afterwards.</summary>
    ...
    /// </summary>
    /// <remarks>
    /// A Velopack install looks like <c>…\Greenlight.SabreClient\current\Greenlight.SabreClient.exe</c>,
